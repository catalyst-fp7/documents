...
\makeevenhead{catalystp}{}{\includegraphics{images/catalyst_header.png}}{\includegraphics{images/europe.png}}
\makeoddhead{catalystp}{}{\includegraphics{images/catalyst_header.png}}{\includegraphics{images/europe.png}}
...
\renewcommand{\@maketitle}{%
  ...
  \vspace{3cm}
  \includegraphics[scale=0.7]{images/flag_yellow_eps.pdf} \par
  \end{center}
  \vspace{2.5cm}

...
\newcommand{\chapterstar}[1]{\clearpage\begin{mdframed}[backgroundcolor=h1b, defaultunit=pt, linewidth=0, innerleftmargin=2, innerrightmargin=4, innertopmargin=3, innerbottommargin=4,skipabove=0,skipbelow=2]\oldchapter*{#1}\end{mdframed}}

\renewcommand*{\cftchapterfont}{\normalfont\bfseries}

\renewcommand{\printtoctitle}[1]{\clearpage\begin{mdframed}[backgroundcolor=h1b, defaultunit=pt, linewidth=0, innerleftmargin=2, innerrightmargin=4, innertopmargin=3, innerbottommargin=4,skipabove=0,skipbelow=2]\printchaptertitle{#1}\end{mdframed}}

\renewcommand{\printloftitle}[1]{\clearpage\begin{mdframed}[backgroundcolor=h1b, defaultunit=pt, linewidth=0, innerleftmargin=2, innerrightmargin=4, innertopmargin=3, innerbottommargin=4,skipabove=0,skipbelow=2]\printchaptertitle{#1}\end{mdframed}}
